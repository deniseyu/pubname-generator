...
var lists = (function(){
  ...
  var data = {
    noun: ["Anchor", "Angel", "Apple", "Arrow", "Ball", "Bayonet", "Bear", "Bell", "Bicycle", "Boar", "Boot", "Bottle", "Bow", "Brick", "Bull", "Candle", "Cane", "Cat", "Chandelier", "Cheese", "Chip", "Clock", "Cock", "Cricket", "Cross", "Crow", "Cup", "Dog", "Dolphin", "Donkey", "Door", "Dragon", "Duck", "Eagle", "Feather", "Fella", "Fiddle", "Fife", "Flag", "Flute", "Frog", "Gauntlet", "Goat", "Goblet", "Goose", "Grape", "Gun", "Hare", "Harp", "Hart", "Hat", "Hawk", "Hen", "Horse", "Hound", "Key", "Lamb", "Lamp", "Lance", "Lyre", "Mill", "Mirror", "Moon", "Moose", "Nightingale", "Pen", "Pheasant", "Plow", "Quill", "Rabbit", "Ram", "Raven", "Rooster", "Sardine", "Sceptre", "Scroll", "Shield", "Ship", "Staff", "Stag", "Stallion", "Star", "Stone", "Sun", "Swan", "Sword", "Violin", "Wagon", "Wheel"],
    ...
    describer: ["Bent", "Black", "Cockney", "Copper", "Crooked", "Dancing", "English", "Famous", "Fighting", "Free", "Golden", "Green", "Jolly", "Laughing", "Merry", "Metal", "Old", "Prancing", "Red", "Ruby", "Rusty", "Scottish", "Singing", "Sleepy", "Silver", "White", "Wild", "Wooden", "Yellow", "Young"],
